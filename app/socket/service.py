...
class SocketService:
	...
	async def download_step_progress(self, data: BaseModel):
		"""
		Emit a download step progress event with the provided data.
		"""
		await self.emit(SocketEvents.DOWNLOAD_STEP_PROGRESS, data=data.model_dump())
