...
class TestSchedulerCompleteness:
	...
	def test_all_samplers_have_scheduler_mapping(self):
	...
	def test_all_samplers_have_display_names(self):
	...
	def test_all_samplers_have_descriptions(self):
	...
	def test_scheduler_mapping_returns_valid_classes(self):
	...
	def test_scheduler_names_are_non_empty_strings(self):
	...
	def test_scheduler_descriptions_are_non_empty_strings(self):
	...
	def test_total_scheduler_count(self):
	...
	def test_new_schedulers_exist(self):
	...
	def test_new_schedulers_have_complete_metadata(self, sampler_name):
