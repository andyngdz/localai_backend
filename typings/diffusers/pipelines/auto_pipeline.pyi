...
class AutoPipelineForText2Image:
	...
	def to(self, device: str | torch.device) -> AutoPipelineForText2Image: ...
	def to_empty(self, device: str | torch.device) -> AutoPipelineForText2Image: ...
	@classmethod
...
class AutoPipelineForImage2Image:
	...
	def unload_lora_weights(self) -> None: ...
	def reset_device_map(self) -> None: ...
	def to(self, device: str | torch.device) -> AutoPipelineForImage2Image: ...
	def to_empty(self, device: str | torch.device) -> AutoPipelineForImage2Image: ...
	@classmethod
